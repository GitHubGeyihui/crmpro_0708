...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript">
		   $(function(){
               $.ajax({
                   type:'GET',
                   url:'${pageContext.request.contextPath}/cus/layuishowInfo',
                   dataType:"json",
                   success:function(rs){
                        $(rs.data).each(function(index,item){
                             var op="<option value="+item.id+","+item.companyperson+">"+item.comname+"</option>";
							 $("#com").append(op);
						});
                   }
               });
               $.ajax({
                   type:'GET',
                   url:'${pageContext.request.contextPath}/emp/showEmpInfo?mark=1',
                   dataType:"json",
                   success:function(rs){
...
<form name="form2" id="forms" action="${pageContext.request.contextPath}/pro/saveInfo" method="POST">
   <input type="hidden" id="cm" name="comname">
